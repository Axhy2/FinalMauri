Module Functions
    ...
    Public conexion As New SqlClient.SqlConnection("Data Source=LAB-L03\SQLEXPRESS; Initial Catalog=FinalMauri2022;Integrated Security=True") 'IZO-> LAB-L03\SQLEXPRESS \\ Casa->DESKTOP-10PSI9B
